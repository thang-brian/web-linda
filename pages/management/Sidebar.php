<div class="border">
    <img style="width: 100%;" src="img/logo_ql.png" alt="logo">
    <div class="flex">
        <div class="gb_9a">
            <div class="gb_ab">
                ...
                <div class="gb_ib gb_eb">
                    ...
                    <path d="M20 5h-3.17L15 3H9L7.17 5H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 14H4V7h16v12zM12 9c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"></path></svg></a>
                </div>
            </div>
        </div>
    ...
    <div>
        <div>
            ...
            <a class="list-group-item list-group-item-action active" data-toggle="collapse" href="#collapse1" role="button" aria-expanded="false" aria-controls="collapseExample">
