<div class="p-2">
    ...
    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="chothue-tab">
    <div style="display:flex !important;">
            <h4>Thông tin cơ bản</h4>
            <hr style="width:66% !important">
        </div>
    ...
    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="canmua-tab">
    <div style="display:flex !important;">
            <h4>Thông tin cơ bản</h4>
            <hr style="width:66% !important">
        </div>
    ...
    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="canthue-tab">
    <div style="display:flex !important;">
            <h4>Thông tin cơ bản</h4>
            <hr style="width:66% !important">
        </div>
