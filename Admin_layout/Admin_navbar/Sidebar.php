               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../public/TrangQuanTri.php?Admin=manage_main" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="../public/TrangQuanTri.php?Admin=product_show" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Danh sách sản phẩm</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../public/TrangQuanTri.php?Admin=product_add" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../public/TrangQuanTri.php?Admin=category_show" class="nav-link" onclick="QuangCao()">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Danh sách danh mục</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../public/TrangQuanTri.php?Admin=category_add" class="nav-link" onclick="QuangCao()">
                                <i class="far fa-circle nav-icon"></i>
